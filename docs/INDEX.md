...
updated: 2026-08-12 (V42 geschlossen -- ua unterscheidet nicht zwischen Claude-Oberflächen; Gate-A→B nur noch Punkt 3 offen)
---
# Doc Index (L0)
...
- [phase6_shares/CLAUDE.md](../phase6_shares/CLAUDE.md) — 🔄 ~19KB · phase head; **Block A (Steps 0–3) vollständig gebaut** (Werkzeuge/Betrieb/Update-Banner — Details im Archiv, siehe unten), **GATE A→B nur noch Punkt 3 offen** (Purge-Zeilenrückgang, frühestens 2026-08-28); **[2026-08-12]** Step 4 (Storage-Fundament, Block B: `storage/acl.py`, `folder`/`visibility`/`share_*`, Index-Rebuild-Fix) per Nikinger-Entscheidung vor Gate-Abschluss begonnen und **✅ gebaut** (Punkt 3 bleibt offen, mitgetragen; Charakterisierung P6-D vor+nach byte-identisch grün, 671 Tests, Punkt 3 [visibility-Default] 2026-08-12 entschieden); Kopf am selben Tag unter Softcap rotiert (Steps 1–3 → Archiv); read + newest Session-stopped block first
- [phase6_shares/SESSIONS_ARCHIVE.md](../phase6_shares/SESSIONS_ARCHIVE.md) — 📦 ~36KB · zwei Einträge, newest-first: Steps 1–3 (Werkzeug-Ergonomie, Betrieb, Update-Log/Banner, 2026-08-12-Rotation) + Steps 0–2-Kurzfassung (2026-08-10-Rotation), beide verbatim aus `phase6_shares/CLAUDE.md`
