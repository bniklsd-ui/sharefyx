...
- [phase4_auth/CLAUDE.md](../phase4_auth/CLAUDE.md) — 🔄 ~39KB · phase head; Steps 0–6 ✅ (Step 6 mit allen drei Done-when-Klauseln belegt), Step 7 (Betrieb, Live-Abnahme, Schnitt) 🟡 **14/16 Abnahmezeilen live bestanden — Terminrisiko-Schwelle „code-complete" erreicht, P5 darf beginnen** (2026-07-30); Zeilen 14/15 (Fabian) bestanden nach einem Chromium-`form-action`-CSP-Fix; offen: Zeile 9 (nächste Session), Zeile 16 (erst nach dem Schnitt); enthält die Kurztabelle der Sicherheitsbefunde S1–S8/O1; read + newest Session-stopped block first
- [docs/concepts/P4_ABNAHME_2026-07-29.md](./concepts/P4_ABNAHME_2026-07-29.md) — 📕 ~13KB · Abnahmeprotokoll Phase 4: 14/16 live bestanden (Nachtrag 2026-07-30 für Zeilen 14/15), CLI-Ausschnitt + DB-Gegenprobe als Beleg, Befunde B1–B3 (alle klein, zwei behoben)
...
- [phase4_auth/SESSIONS_ARCHIVE.md](../phase4_auth/SESSIONS_ARCHIVE.md) — 📦 ~53KB · acht archivierte Session-Blöcke (Step 0+1+2, Step 3, V14+Step 4, Step 5, Step 6a, Step 6b, Step-7-Code-Vorbereitung, Befund S1+Sicherheits-Review+12/16-Abnahme), verbatim, newest-first
