...
- [phase6_shares/CLAUDE.md](../phase6_shares/CLAUDE.md) — 🔄 ~37KB · phase head (2026-08-14 siebte Rotation, von Hand — Skript greift nur bei ≥2 Blöcken, hier lag einer vor —, Steps-0–7-Historie + Pre-/Post-Deploy-Verifikation liegt im Archiv, siehe unten); **Block A (Steps 0–3) vollständig gebaut**, **GATE A→B nur noch Punkt 3 offen** (Purge-Zeilenrückgang, frühestens 2026-08-28); **Steps 4–6 (Block B) ✅ gebaut und seit 2026-08-13 live deployed**; **Step 7a + Step 7 (UI Dateisystem, Commits 0–6) ✅ vollständig, getestet (747 pytest + 3 Smoke-Skripte + 30/30 echter Browser-E2E) und seit 2026-08-14 live deployed** (Release `20260814T201901.099704Z`/`70973a14`) — Post-Deploy erneut 30/30 gegen die tatsächlich deployten Bytes, kein Live-Write; Live-Fund `diagnose.sh`-Auth-Backup-Warnung behoben (`phase3_edge/`); vier UI-Feedback-Punkte nach der ersten Live-Nutzung vorgemerkt (Dropdown-Farbe, Space-zu-Space-Move ist bereits als Step 7b geplant, Mehrfachauswahl, Grün→Blau) — nur vorgemerkt, nichts umgesetzt; **Gate B braucht jetzt echte Nutzer/Fabian, nicht mehr den Deploy**; Werkzeug-Ergonomie: die irreführende `patch_item`-Fehlermeldung behoben, fünf Punkte bleiben Vormerkung; read + newest Session-stopped block first
- [phase6_shares/SESSIONS_ARCHIVE.md](../phase6_shares/SESSIONS_ARCHIVE.md) — 📦 ~150KB · neun Einträge, newest-first: **Step 7 + Pre-Deploy-Testschwelle/Deploy/Post-Deploy-Verifikation von v2.1 (Commits 0–6 inkl. 5a/5b-Split, vier Nachträge, siebte 2026-08-14-Rotation — von Hand, Byte-Identität gegen das Original geprüft)** + Step 7a (Textfarben-Token, Wortmarke/Versionen weiß + v2.1, Update-Banner-Split, 2026-08-13-Rotation) + Planungssession `ITEM_MOVE_PLAN.md` (2026-08-13-Rotation) + Step 6 (Verwaltung/Migration + vier Nachträge, 2026-08-13-Rotation) + Step 5 (Rechtepolitik, 2026-08-12-Rotation) + Step 4 (Storage-Fundament, 2026-08-12-Rotation) + Steps 1–3 (Werkzeug-Ergonomie, Betrieb, Update-Log/Banner, 2026-08-12-Rotation) + Steps 0–2-Kurzfassung (2026-08-10-Rotation), alle verbatim aus `phase6_shares/CLAUDE.md`
