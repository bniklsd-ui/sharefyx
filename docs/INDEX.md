...
- [phase2_mcp/CLAUDE.md](../phase2_mcp/CLAUDE.md) — 🔄 ~13KB · phase head; Steps 0–5 ✅, Steps 6–7 offen; read + newest Session-stopped block first
...
- [phase2_mcp/SESSIONS_ARCHIVE.md](../phase2_mcp/SESSIONS_ARCHIVE.md) — 📦 ~21KB · fünf archivierte Session-Blöcke (Step 0–4), verbatim, newest-first
