...
- [phase4_auth/CLAUDE.md](../phase4_auth/CLAUDE.md) — 🔄 ~38KB · phase head; Steps 0–6 ✅ (Step 6 mit allen drei Done-when-Klauseln belegt), Step 7 (Betrieb, Live-Abnahme, Schnitt) 🟡 in Arbeit — S1 live behoben (Schritt 4/5 grün), Connector-Login (Schritt 6) läuft, Abnahmematrix (Schritt 7) als Nächstes über `phase4_auth/scripts/abnahme_run.sh`; enthält die Kurztabelle der Sicherheitsbefunde S1–S8/O1; read + newest Session-stopped block first
