...
- [phase2_mcp/CLAUDE.md](../phase2_mcp/CLAUDE.md) — 🔄 ~18KB · phase head; Steps 0–7 ✅ (code-complete, Quick-Tunnel-Probe durch den Nikinger noch offen); read + newest Session-stopped block first
