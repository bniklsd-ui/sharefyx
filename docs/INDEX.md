...
updated: 2026-08-09 (Phase 6 Step 2 — O2 geschlossen, `ua`-Feld, `diagnose.sh`/`ui_budget.py`-Ergänzungen; Testzahlen/Größen der berührten Köpfe nachgezogen)
---
# Doc Index (L0)
