...
- [phase4_auth/CLAUDE.md](../phase4_auth/CLAUDE.md) — 🔄 ~40KB · phase head; Steps 0–6 ✅ (Step 6 mit allen drei Done-when-Klauseln belegt), Step 7 (Betrieb, Live-Abnahme, Schnitt) 🟡 **12/16 Abnahmezeilen live bestanden** (2026-07-29) — Zeile 9 auf nächste Session vertagt, 14/15 brauchen Fabian, 16 erst nach dem Schnitt; enthält die Kurztabelle der Sicherheitsbefunde S1–S8/O1; read + newest Session-stopped block first
