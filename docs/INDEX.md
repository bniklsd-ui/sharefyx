...
updated: 2026-08-06 (Rotation phase5_ui/CLAUDE.md, Größen nachgezogen)
---
# Doc Index (L0)
...
- [CLAUDE.md](../CLAUDE.md) — 📗 ~40KB · rules, core principle, hard rules, working style, current state; auto-loaded every session — nahe dem 40KB-Softcap, nächste Session prüfen ob eine Rotation/Kompression der ältesten P4-Nachträge fällig ist
