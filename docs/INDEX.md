...
updated: 2026-08-13 (P6 Step 7 Commits 0+1+2+3+4+5a gebaut+verifiziert+committet -- app.js in zehn ES-Module gesplittet, echter Ordnerbaum, Sichtbarkeits-Chip, Ordner anlegen+Verschieben per Menü, Drag & Drop, Re-Auth-Gate Backend-Hälfte (Freigabe-Dialog auf 5b verschoben); Step 7a weiter Deploy beim Nikinger; Gate-A→B nur noch Punkt 3 offen)
---
# Doc Index (L0)
