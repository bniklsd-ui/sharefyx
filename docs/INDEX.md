...
updated: 2026-08-14 (P6 Step 7 vollständig, Commits 0-6 -- app.js in zehn ES-Module gesplittet, echter Ordnerbaum, Sichtbarkeits-Chip, Ordner anlegen+Verschieben per Menü, Drag & Drop, Re-Auth-Gate + Freigabe-Dialog, space_admin_enabled-Stub; phase6_shares/CLAUDE.md rotiert; Werkzeug-Ergonomie-Feedback vorgemerkt; Step 7a weiter Deploy beim Nikinger; Gate-A→B nur noch Punkt 3 offen)
---
# Doc Index (L0)
...
- [phase6_shares/CLAUDE.md](../phase6_shares/CLAUDE.md) — 🔄 ~33KB · phase head (2026-08-14 vierte Rotation, von Hand — Skript greift nur bei ≥2 Blöcken, hier lag einer vor —, Steps-0–7-Historie liegt im Archiv, siehe unten); **Block A (Steps 0–3) vollständig gebaut**, **GATE A→B nur noch Punkt 3 offen** (Purge-Zeilenrückgang, frühestens 2026-08-28); **Steps 4–6 (Block B) ✅ gebaut und seit 2026-08-13 live deployed** — Cutover auf `SharePolicy` vollzogen, `niklas`↔`fabian` per `.share.yml` gegenseitig lesbar gehalten, eine Richtung über den echten Connector verifiziert (fabian→niklas offen), neuer Shared Space `IT-Sekus-Projekt`; der UI-Fund „nur lesen trotz Schreibrecht" ist in **beiden** Teilen deployed und live bestätigt (Release `20260813T120925.743482Z`/`92b918b`); **Step 7a (Textfarben-Token) ✅ gebaut, Deploy beim Nikinger** (Sudo-Neustart außerhalb dessen, was Claude Code selbst kann); **Step 7 (UI Dateisystem) ✅ vollständig, Commits 0–6** (`app.js` in zehn ES-Module gesplittet, echter Ordnerbaum, Sichtbarkeits-Chip, Ordner anlegen+Verschieben per Menü [K4-Fix], Drag & Drop, Re-Auth-Gate + Freigabe-Dialog, `space_admin_enabled`-Stub — 747 grün, Tabu-Diff sauber), **noch nicht deployt**; Werkzeug-Ergonomie-Feedback einer arbeitenden Claude-Instanz (2026-08-14) als Vormerkung aufgenommen, nichts gebaut; read + newest Session-stopped block first
- [phase6_shares/SESSIONS_ARCHIVE.md](../phase6_shares/SESSIONS_ARCHIVE.md) — 📦 ~139KB · acht Einträge, newest-first: **Step 7 (UI Dateisystem, Commits 0–6 inkl. 5a/5b-Split, vierte 2026-08-14-Rotation — von Hand, Byte-Identität gegen das Original geprüft)** + Step 7a (Textfarben-Token, Wortmarke/Versionen weiß + v2.1, Update-Banner-Split, 2026-08-13-Rotation, dritte an diesem Tag) + Planungssession `ITEM_MOVE_PLAN.md` (2026-08-13-Rotation, zweite an diesem Tag) + Step 6 (Verwaltung/Migration + die vier Nachträge: Tool-Beschreibungen, Live-Cutover der Steps 4–6, Wortmarken-Version, UI-Fund „nur lesen" inkl. datierter Korrekturnotiz zum Deploy — erste 2026-08-13-Rotation) + Step 5 (Rechtepolitik, 2026-08-12-Rotation) + Step 4 (Storage-Fundament, 2026-08-12-Rotation) + Steps 1–3 (Werkzeug-Ergonomie, Betrieb, Update-Log/Banner, 2026-08-12-Rotation) + Steps 0–2-Kurzfassung (2026-08-10-Rotation), alle verbatim aus `phase6_shares/CLAUDE.md`
...
- [phase6_shares/ITEM_MOVE_PLAN.md](../phase6_shares/ITEM_MOVE_PLAN.md) — 📗 ~27KB · **[2026-08-13 neu]** Zusatzplan zu P6 Step 7, gegen den echten Code (`main`@`92b918b`) verifiziert: **Item-Verschieben zwischen Ordnern und Spaces** + die UI-Bedienung dafür, plus ein unabhängiger Lesbarkeitsfix der Textfarben-Token. Entscheidungen **P6-AD–P6-AJ**, Abnahmezeilen **25–30**, `[VERIFY]` **V52–V55**, Nebenbefunde **O6/O7**. Drei Schnitte: **Step 7a** (CSS-Token, jederzeit lieferbar) · Step 7 (unverändert, Hauptplan) · **Step 7b** (Cross-Space-Move, setzt Step 7 voraus). Korrigiert vier Annahmen der Planungsvormerkung vom selben Tag — u. a. dass Ordner-Verschieben **innerhalb** eines Space auf allen drei Schichten längst gebaut ist und nur die UI dafür fehlt. Geteilte Spaces über die UI anlegen bleibt ausdrücklich draußen (P6-V)
