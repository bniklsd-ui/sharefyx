...
- [phase6_shares/CLAUDE.md](../phase6_shares/CLAUDE.md) — 🔄 ~35KB · phase head (2026-08-16 achte Rotation, von Hand, kein Softcap-Auslöser diesmal — reine Ein-Block-pro-Session-Disziplin, volle Historie im Archiv, siehe unten); **Block A (Steps 0–3) vollständig gebaut**, **GATE A→B nur noch Punkt 3 offen** (Purge-Zeilenrückgang, frühestens 2026-08-28); **Steps 4–6 (Block B) ✅ gebaut und seit 2026-08-13 live deployed**; **Step 7a + Step 7 (UI Dateisystem, Commits 0–6) ✅ vollständig, getestet und seit 2026-08-14 live deployed** (Release `20260814T201901.099704Z`/`70973a14`, Post-Deploy 30/30 gegen die tatsächlich deployten Bytes); **[2026-08-16]** zwei der vier UI-Feedback-Punkte umgesetzt — Dropdown-Lila behoben (`select.input { accent-color: var(--accent) }`), Grün→Blau (`--ok`-Token entfernt, `.toast`/`.visibility-chip--shared` auf `--accent`), live per Playwright bestätigt, 747 pytest unverändert; die beiden größeren Punkte (Space-zu-Space-Move = Step 7b, Mehrfachauswahl) bleiben Vormerkung; **Gate B braucht jetzt echte Nutzer/Fabian, nicht mehr den Deploy**; Werkzeug-Ergonomie: die irreführende `patch_item`-Fehlermeldung behoben, fünf Punkte bleiben Vormerkung; read + newest Session-stopped block first
- [phase6_shares/SESSIONS_ARCHIVE.md](../phase6_shares/SESSIONS_ARCHIVE.md) — 📦 ~159KB · zehn Einträge, newest-first: **v2.1-Deploy-Session (Pre-Deploy-Testschwelle, Werkzeug-Ergonomie-Fix, UPDATE_LOG, Post-Deploy-Verifikation, achte 2026-08-16-Rotation — von Hand, Byte-Identität gegen das Original geprüft)** + Step 7 (Commits 0–6 inkl. 5a/5b-Split, siebte 2026-08-14-Rotation) + Step 7a (Textfarben-Token, Wortmarke/Versionen weiß + v2.1, Update-Banner-Split, 2026-08-13-Rotation) + Planungssession `ITEM_MOVE_PLAN.md` (2026-08-13-Rotation) + Step 6 (Verwaltung/Migration + vier Nachträge, 2026-08-13-Rotation) + Step 5 (Rechtepolitik, 2026-08-12-Rotation) + Step 4 (Storage-Fundament, 2026-08-12-Rotation) + Steps 1–3 (Werkzeug-Ergonomie, Betrieb, Update-Log/Banner, 2026-08-12-Rotation) + Steps 0–2-Kurzfassung (2026-08-10-Rotation), alle verbatim aus `phase6_shares/CLAUDE.md`
